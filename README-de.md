...
**Secret News Club** ist ein Android RSS-Reader, präsentiert im [Material You](https://m3.material.io/) Designstil.
...
**Secret News Club** ist mit einigen APIs von Drittanbietern kompatibel, um bei der Nutzung Ihrer bestehenden Cloud-Konten als Datenquellen zu unterstützen.
...
**Secret News Club** ist eine kostenlose Open-Source-Software, die von der Open-Source-Gemeinschaft profitiert, und jeder Benutzer kann ihre volle Funktionalität kostenlos genießen. Wenn Sie also meine aktuelle Arbeit wertschätzen, können Sie mir gerne eine Tasse Kaffee spendieren ☕️.
...
Vielen Dank an alle **Secret News Club** Übersetzer, und wenn Sie einen Beitrag leisten möchten, reichen Sie bitte eine Übersetzung über [Weblate](https://hosted.weblate.org/engage/readyou/) ein.
...
**Secret News Club** ist auf der Android nativen [Jetpack Compose](https://developer.android.com/jetpack/compose) Architektur implementiert.

1. Zuerst müssen Sie sich den Quellcode von **Secret News Club** herunterladen.
...
Vielen Dank an **@Kyant0** für die Design-Inspiration und die Implementierung der Monet-Engine für **Secret News Club**.
...
Vielen Dank an **JetBrains** für die Bereitstellung von kostenlosen Open-Source-Lizenzen für IDEs für **Secret News Club**.

[<img src="https://hosted.weblate.org/widgets/readyou/-/287x66-white.png"  width="200"/>](https://hosted.weblate.org/engage/readyou/)

Vielen Dank an **Weblate** für das kostenlose Hosting von Open-Source-Projekten für **Secret News Club**.
