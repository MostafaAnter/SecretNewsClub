...
**Secret News Club** 是一个以 [Material You](https://m3.material.io/) 风格呈现的 Android RSS 阅读器，这些是目前已完成的功能和未来要做的事。
...
**Secret News Club** 也集成了一些第三方服务 API，支持您使用已有的云端账户来作为数据源。
...
**Secret News Club** 是一款免费的自由开源软件，它受益于开源社区，每一位用户都能够免费享受到它完整的功能，如果您赞赏我目前的工作，可以选择请我喝一杯咖啡 ☕️。
...
感谢每一位 **Secret News Club** 的翻译人员，如果您也希望做出贡献，请通过 [Weblate](https://hosted.weblate.org/engage/readyou/) 来提交翻译文本。
...
**Secret News Club** 基于 [Jetpack Compose](https://developer.android.com/jetpack/compose) 工具包来构建 Android 原生用户界面。

1. 首先您需要获取 **Secret News Club** 的源代码：
...
感谢 **@Kyant0** 为 **Secret News Club** 提供的设计灵感与 Monet 引擎实现。
