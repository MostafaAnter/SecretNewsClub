package secret.news.club.infrastructure.net

import secret.news.club.infrastructure.net.ApiResult.BizError
import secret.news.club.infrastructure.net.ApiResult.NetworkError
import secret.news.club.infrastructure.net.ApiResult.Success
